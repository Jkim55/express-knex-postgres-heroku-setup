...
- `knex migrate:latest --env production` to run knex migration locally against heroku database in the cloud
- `knex seed:run --env production` to run knex locally & puts seed data in heroku database
